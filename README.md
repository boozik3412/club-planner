...
- 19 шаблонов предметов, включая произвольные прямоугольник, круг и овал, дверь и окно; точные размеры в метрах, drag/resize/rotate, подписи, слои и блокировка;
