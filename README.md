...
- точный векторный план `assets/base_plan_new_measurement.svg`, сетка, привязка, зум, панорама и поворот холста;
- 14 шаблонов предметов, точные размеры в метрах, drag/resize/rotate, подписи, слои и блокировка;
