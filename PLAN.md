...
Статус: этапы 0–15 реализованы и опубликованы в `v0.1.3`. Этапы 16–21 — в работе: локальный импорт и распознавание планировки, редактируемая архитектура и `.clubplan` v4.
...
### Этап 16 — формат v4 и проектная архитектура
...
### Этап 17 — локальный импорт и распознаватель
...
### Этап 18 — редактор проверки архитектуры
...
### Этап 19 — 2D, привязки, помещения и 3D
...
### Этап 20 — безопасность, качество и корпус
...
- измерять precision/recall и метрическую ошибку отдельно для векторных PDF, сканов и фотографий;
...
### Этап 21 — документация и Windows-релиз
...
- повысить версию, собрать portable EXE, NSIS installer и подписанные updater-артефакты; sidecar/ресурсы распознавания должны входить в каждый вариант поставки.
