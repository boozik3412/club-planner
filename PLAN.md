...
Статус: реализация этапов 16–21 и локальная Windows-проверка `v0.2.0` завершены. Открытые release-gates: метрический F1 benchmark, подписанные updater-артефакты CI и clean-VM smoke.
