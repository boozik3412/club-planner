...
Статус: этапы 0–14 реализованы и опубликованы в `v0.1.2`. Этап 15 — раскладко-независимые горячие клавиши, умное совмещение рядов, зеркальное отражение, разделение перегородок и экспорт PDF — реализован и локально проверен для `v0.1.3`. Проверка установки на отдельной чистой Windows VM остаётся дополнительным внешним release-gate.
